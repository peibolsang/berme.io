...
export const buildHomeMarkdownDocument = ({
  ...
  return joinSections([
    ...
    "---",
    "After 15 years leading product in vertical SaaS, I’ve learned that technology often changes faster than we can make sense of it.",
    "I try to close that gap by studying new technologies from first principles, connecting ideas, and testing them in practice. This is where I put what I learn in service of something greater.",
    "## Available Views",
    "- [Posts](/?view=posts)",
    "- [Views](/?view=views)",
    "- [Books](/?view=books)",
